<template>
    <nav id="navBar" class=" p-1 flex flex-col justify-between">
        
        <div id="subNavBar1" class="flex flex-row justify-between mx-4">
            <div>
                <img src="/SkyRoutes_Logo_White.svg" alt="SkyRoutes Logo" class="w-12 pt-4">
            </div>
            <div id="icono">
        ...
        <div id="subNavBar2" class="flex flex-wrap justify-between">
